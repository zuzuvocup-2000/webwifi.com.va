(function ($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function (opts) {
        ...
        this.each(function () {
            ...
            let counter = 0;
            let dragbox = $(
                `<div class="imageuploadify well"><div class="imageuploadify-images-list"><div class="view-list-image"></div><div class="wrap-btn-upload"><i class="fa fa-camera mr5"></i><button type="button"class="btn btn-default">Chọn hình</button></div></div></div>`
            );
            let overlay = dragbox.find(".imageuploadify-overlay");
            let uploadIcon = dragbox.find(".imageuploadify-overlay i");
            let imagesList = dragbox.find(".view-list-image");
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(
                    `<div class='imageuploadify-container'><button type='button'class='btn btn-danger glyphicon glyphicon-remove'>x</button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`
                );
            ...
            button
                .mouseenter(function onMouseEnter(event) {
                    button.css("background", "transparent").css("color", "#3AA0FF");
                })
                .mouseleave(function onMouseLeave() {
                    button.css("background", "transparent").css("color", "#000");
                });
