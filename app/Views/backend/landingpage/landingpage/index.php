                ...
                <div class="ibox-content">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/landingpage/landingpage/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm Landingpage mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                            ...
                            <?php if(isset($landingpageList) && is_array($landingpageList) && count($landingpageList)){ ?>
                            <?php foreach($landingpageList as $key => $val){ ?>
                            <?php
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td>
                                    <div class="uk-flex uk-flex-middle">
                                        <div class="main-info">
                                            <div class="title"><a class="maintitle" href="<?php echo site_url('backend/landingpage/landingpage/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed']; ?>)</a></div>
                                        </div>
                                    </div>
                                </td>
                                <?php if(isset($languageList) && is_array($languageList) && count($languageList)){ ?>
                                ...
                                <td class="text-center">
                                    <a type="button" href="<?php echo base_url('backend/landingpage/landingpage/update/'.$val['id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a type="button" href="<?php echo base_url('backend/landingpage/landingpage/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
