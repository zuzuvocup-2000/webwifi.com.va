...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2><?php echo translate('cms_lang.post.post_delete', $language) ?>: <?php echo $file['title'] ?></h2>
		<ol class="breadcrumb">
			<li>
						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('title', set_value('title', $file['title']), 'class="form-control" disabled placeholder="" autocomplete="off"');?>
									<?php echo form_hidden('id', set_value('id', $file['id']), 'class="form-control" disabled placeholder="" autocomplete="off"');?>
								</div>
							</div>
						</div>
