            ...
            <div class="col-lg-3">
                <div class="panel-head">
                    ...
                    <div class="form-row ">
                        ...
                        <?php echo form_input('time_end', htmlspecialchars_decode(html_entity_decode(set_value('time_end', (isset($panel['time_end'])) ? $panel['time_end'] : ''))), 'class="form-control simplepicker"  placeholder="" autocomplete="off" ');?>
                    </div>
                </div>
            </div>
            <div class="col-lg-9">
                    ...
                    <div class="row mb15">
                        ...
                        <div class="col-lg-6">
                            <div class="form-row">
                                ...
                                <?php echo form_input('image', set_value('image', (isset($panel['image'])) ? $panel['image'] : ''), 'class="form-control icon-display" onclick="" placeholder="" autocomplete="off" data-flag="0" ');?>
                            </div>
                        </div>
                    </div>
                    <div class="row mb15">
                    ...
                    <div class="row mb15">
                        <div class="col-lg-12">
                            <div class="form-row">
                               ...
                               <?php echo form_dropdown('locate', $locate, set_value('locate', (isset($panel['locate'])) ? $panel['locate'] : ''), 'data-module= "'.$module.'" class="form-control m-b select2 "');?>
                            </div>   
                        </div>   
                    </div>
                    <div class="row mb15">
                        <div class="col-lg-12">
                            <div class="form-row">
                               ...
                               <?php echo form_dropdown('module', $dropdown, set_value('module', (isset($panel['module'])) ? $panel['module'] : ''), 'data-module= "'.$module.'" class="form-control m-b select2 select2_panel"');?>
                            </div>   
                        </div>   
                    </div>
                                    ...
                                    <div>
                                       <div class="i-checks clearfix">
                                            <label class="uk-flex uk-flex-middle">
                                                <input style="margin-top:0;margin-right:10px" name="select_type[]" type="checkbox" <?php echo (($panel['type_data'] != '')  && in_array('only_post', $panel['type_data'])) ? 'checked' : '' ?> value="only_post">
                                                <span>Lấy bài viết</span>
                                            </label>
                                        </div>
                                        <div class="i-checks clearfix">
                                            <label class="uk-flex uk-flex-middle">
                                                <input style="margin-top:0;margin-right:10px" name="select_type[]" type="checkbox" <?php echo (($panel['type_data'] != '')  && in_array('only_cat', $panel['type_data'])) ? 'checked' : '' ?> value="only_cat">
