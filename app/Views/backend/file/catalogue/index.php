...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý Danh mục Tài liệu</strong></li>
      </ol>
   </div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Quản lý Danh mục Tài liệu </h5>
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/file/catalogue/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm mới nhóm Tài liệu</a>
                                    </div>
                                </div>
                            </div>
                        </div>
