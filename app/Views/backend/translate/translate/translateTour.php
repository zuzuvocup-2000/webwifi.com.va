					...
					<div class="row mb15">
						...
						<div class="col-lg-12">
							<div class="form-row">
								...
								<?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', (isset($object['content']) && $object['content'] != '') ? base64_decode($object['content']) : ''))), 'class="form-control ck-editor" id="content" placeholder="" autocomplete="off"');?>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row form-description">
									...
									<?php echo form_textarea('description', htmlspecialchars_decode(html_entity_decode(set_value('description', (isset($translate['description'])) ? base64_decode($translate['description']) : '')), ENT_QUOTES), 'class="form-control ck-editor" id="description_translate" placeholder="" autocomplete="off"');?>
								</div>
							</div>
